...
export class SampleApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getDatasets(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
   ...
   *
   * @param {object} fields Define the filter conditions by specifying the name of values of fields requested. There is also support for a `text` search to look for strings anywhere in the sample. Skip and limit parameters allow for paging.
   *
